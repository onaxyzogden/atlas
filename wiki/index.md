...
- [2026-04-21 Scoring Type Contract](decisions/2026-04-21-scoring-type-contract.md) — Discriminated-union `MockLayerResult` for 4 Tier-1 ecological layers + zod validator at API DB boundary; closes audit issue 5.6 (`wetland_pct.toFixed` crash class)
