...
**Date:** 2026-05-02
**Status:** Partially Accepted 2026-05-04 — D1 (MT per-project gating + `project_moontrance_identity` migration 022) and D2 (FUTURE → LATENT rename across `featureManifest.ts`, `featureGate.ts`, route + scaffold-section) landed. D3 (P4 public portal auth + cache) remains deferred.
