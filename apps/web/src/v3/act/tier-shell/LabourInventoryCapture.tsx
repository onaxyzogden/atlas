...
const CAP_MAP: readonly CapBand[] = [
  ...
  },
  {
    ...
    note: 'At {h} hrs/week, OLOS will sequence Stratum 2 surveys slowly -- expect 8-10 weeks for Land Reading.',
  },
  {
    max: 25,
    pct: 38,
    ...
    note: 'At {h} hrs/week, OLOS will pace Act tasks to avoid overload. Stratum 2 surveys will be sequenced across 4-6 weeks.',
  },
  {
    max: 40,
    pct: 55,
    ...
    note: 'At {h} hrs/week, Stratum 2 Land Reading can complete in 3-4 weeks. Multiple parallel tasks will be recommended.',
  },
  {
    max: 60,
    pct: 72,
