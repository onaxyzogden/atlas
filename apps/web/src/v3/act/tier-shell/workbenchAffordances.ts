...
// st-* prefix is taken by ev-s4-settlement-strategy, hence sw-* here.) The
// standalone operational-roles item s1-steward-c9 (ADR 2026-06-24) was retired
// 2026-06-28 -- its pills folded into c2's sw-roles capture -- so it has no
// badge of its own.
