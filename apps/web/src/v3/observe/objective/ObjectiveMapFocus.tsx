/**
 * ObjectiveMapFocus — drives the camera when an objective is in focus. On entry
 * (and whenever the target changes) it flies the map to the objective's target
...
import type { FieldObjective } from '../../objectives/fieldObjective.js';
...
export default function ObjectiveMapFocus({ map, objective }: Props) {
