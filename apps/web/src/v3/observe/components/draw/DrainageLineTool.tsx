...
export default function DrainageLineTool({ map, projectId, getSnapTargets }: Props) {
  ...
  return (
    <div className={css.popover} role="dialog" aria-label="Drainage line">
      ...
      <span className={css.hint}>
        Trace where water collects and exits (Freehand) or set Length × Bearing (Dimensions).
      </span>
