...
export const VISION_QUESTIONS: VisionQuestion[] = [
  // Step 1 — Project Type
  {
    ...
    options: [
      { id: 'regenerative_farm', label: 'Regenerative Farm', description: 'Food, fiber, and ecosystem production', activates: ['soil-fertility', 'plant-systems', 'water-management'] },
      { id: 'homestead', label: 'Homestead', description: 'Self-sufficient living on rural land', activates: ['zone-circulation', 'structures-subsystems'] },
      { id: 'intentional_community', label: 'Intentional Community', description: 'Shared values, governance, and resources', activates: ['zone-circulation', 'structures-subsystems'] },
      { id: 'eco_village', label: 'Eco-village', description: 'Sustainable village or co-living model', activates: ['zone-circulation', 'structures-subsystems'] },
      ...
      { id: 'agritourism', label: 'Agritourism Destination', description: 'Revenue from on-land experiences', activates: ['zone-circulation', 'structures-subsystems'] },
      { id: 'retreat_education', label: 'Retreat / Education Centre', description: 'Learning, research, and training', activates: ['structures-subsystems', 'zone-circulation'] },
      { id: 'silvopasture', label: 'Silvopasture / Livestock', description: 'Integrated trees, forage, and animals', activates: ['livestock', 'plant-systems'] },
      ...
      { id: 'market_garden', label: 'Market Garden', description: 'Intensive crop production for sale', activates: ['plant-systems', 'soil-fertility'] },
      { id: 'mixed_use', label: 'Mixed-Use Land Stewardship', description: 'Multiple uses and revenue streams', activates: ['phasing-budgeting'] },
