/**
 * HandoffSection — dispatches to the stage-specific handoff component for
 * the objective being worked. Mounts in ObjectiveWorkspace's side panel and
...
export default function HandoffSection({ projectId, objective }: Props) {
  ...
  return <ActFeedbackLoop projectId={projectId} objective={objective} />;
}
