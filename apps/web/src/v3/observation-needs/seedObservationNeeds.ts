...
export const SEED_OBSERVATION_NEEDS: ObservationNeed[] = [
  ...
  },
  {
    ...
    requiredLayers: ['built-infrastructure'],
    checklist: [
  ...
  },
  {
    ...
    requiredLayers: ['people-governance'],
    checklist: [
  ...
  },
  {
    ...
    requiredLayers: ['hydrology', 'hydrology'],
    checklist: [
  ...
  },
  {
    ...
    requiredLayers: ['access-circulation'],
    checklist: [
