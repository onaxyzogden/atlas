/**
 * actHowChecksStore — per-project per-module checklist state for the
 * Act right-rail GuidanceCard "How" steps.
 *
 * Mirrors observeHowChecksStore / planHowChecksStore.
 */
...
export const useActHowChecksStore = create<ActHowChecksState>()(
  persist(
    ...
    }),
    {
      ...
      version: 1,
      migrate: (persisted) => persisted as ActHowChecksState,
    },
  ),
);
