...
const SCORE_EXPLANATIONS: ScoreExplanation[] = [
  ...
  { label: 'Water Retention', description: 'How much water the site can passively hold \u2014 soil available water capacity, organic matter, pond and swale potential, detention zones, drainage density, wetland coverage.', weight: 'diagnostic (not weighted)', howToImprove: 'Build swales and check-dams on contour, establish ponds in natural depressions, add deep-rooted perennials and cover crops to raise soil organic matter.' },
  { label: 'Drought Resilience', description: 'How well the site buffers dry periods \u2014 aridity class, water balance surplus, rainwater harvest potential, soil plant-available water, groundwater access, baseline water stress.', weight: 'diagnostic (not weighted)', howToImprove: 'Size rainwater storage to annual deficit, establish drought-tolerant keyline planting, protect wetland refugia, add mulch and shade to cut ET loss.' },
  { label: 'Storm Resilience', description: 'How well the site absorbs extreme rainfall \u2014 inverse runoff concentration, swale/detention density, flood-zone exposure, hydrologic group, tree canopy, riparian buffer width.', weight: 'diagnostic (not weighted)', howToImprove: 'Widen riparian buffers, increase tree canopy on overland-flow paths, build distributed swales to slow-spread-sink runoff, avoid siting hardscape in detention zones.' },
];
