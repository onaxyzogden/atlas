...
// stale pre-v1.2 summary (v1.2 added the Tier 6 adaptive-management objective).
//
// Inline "Expanded by: Ecovillage / Community" items on the UNIVERSAL objectives
// (Tier 0 stakeholders, Tier 4 access, Tier 4 water harvesting) are NOT
...
//
// Ref note: the source numbers TWO Tier 6 objectives "6.6" - "Define enterprise
...
// objective is given the next free slot, EV-T6.9, to keep refs unique. All
...
//
// Economic objectives EV-T3.8 (financial contribution & shared economics) and
// EV-T6.5 (communal financial plan & capital contribution schedule) are encoded
...
export const ECOVILLAGE_PRIMARY_OBJECTIVES: readonly PlanTierObjective[] = [
  // ---------------------------------------------------------------- Tier 0
  obj({
    id: 'ev-t0-legal-governance',
  ...
  obj({
    ...
    checklist: [
      ck(
        'ev-t2-water-yield-c1',
        'Calculate total water demand for intended population - domestic, food production, animals, fire protection',
      ),
      ck(
        'ev-t2-water-yield-c2',
        'Assess all available water source yields across dry and wet seasons',
      ),
      ck('ev-t2-water-yield-c3', 'Map seasonal supply and demand curves - identify gap periods'),
      ck('ev-t2-water-yield-c4', 'Assess water quality for domestic and food production use'),
      ck('ev-t2-water-yield-c5', 'Identify storage requirements to bridge seasonal gaps'),
      ck('ev-t2-water-yield-c6', 'Define maximum population supportable by available water'),
    ],
    completionGate:
  ...
  obj({
    ...
    checklist: [
      ck(
        'ev-t2-energy-potential-c1',
        'Assess solar generation potential - roof area, ground-mount zones, shading analysis',
      ),
      ck(
        'ev-t2-energy-potential-c2',
        'Assess wind generation potential - speed, consistency, regulatory constraints',
      ),
      ck('ev-t2-energy-potential-c3', 'Assess micro-hydro potential if running water present'),
      ck('ev-t2-energy-potential-c4', 'Assess biomass and wood fuel production capacity'),
      ck(
        'ev-t2-energy-potential-c5',
        'Estimate total community energy demand for intended population',
      ),
      ck(
        'ev-t2-energy-potential-c6',
  ...
  obj({
    ...
    focusedQuestion:
      'How will food be produced and distributed across this community - communal growing, individual plots, or hybrid - and how does this connect to the provision balance decided in Tier 0?',
    checklist: [
      ck(
        'ev-t3-food-system-c1',
        'Confirm food system approach from Tier 0 provision balance - communal, individual, or hybrid',
      ),
      ck(
        'ev-t3-food-system-c2',
        'Define communal food production commitments - crops, volume, labour contribution model',
      ),
      ck(
        'ev-t3-food-system-c3',
        'Define individual plot allocation - size, location, tenure, maintenance obligations',
      ),
      ck(
        'ev-t3-food-system-c4',
        'Define food sharing and distribution protocol for communal harvests',
      ),
      ck(
        'ev-t3-food-system-c5',
        'Define seed saving, variety selection, and food sovereignty strategy',
      ),
      ck('ev-t3-food-system-c6', 'Establish food system governance - decisions, labour, disputes'),
    ],
    completionGate:
  ...
  obj({
    ...
    checklist: [
      ck(
        'ev-t4-communal-systems-c1',
        'Design communal kitchen and dining facility - capacity, equipment, layout',
      ),
      ck(
        'ev-t4-communal-systems-c2',
        'Design meeting hall - capacity, acoustics, flexibility for different uses',
      ),
      ck(
        'ev-t4-communal-systems-c3',
        'Design workshop and tool library - storage, workbench layout, safety',
      ),
      ck('ev-t4-communal-systems-c4', 'Design communal laundry and shared service facilities'),
      ck(
        'ev-t4-communal-systems-c5',
        'Specify materials and construction standards for communal buildings',
      ),
      ck(
        'ev-t4-communal-systems-c6',
        'Confirm communal building designs are financially achievable within Tier 3 model',
      ),
    ],
    completionGate:
  ...
  obj({
    ...
    checklist: [
      ck(
        'ev-t4-sanitation-waste-c1',
        'Design sewage treatment system - composting toilets, biodigester, constructed wetland, or connection to municipal system',
      ),
      ck('ev-t4-sanitation-waste-c2', 'Design grey water collection, treatment, and reuse network'),
      ck(
        'ev-t4-sanitation-waste-c3',
        'Design communal organic waste processing - compost bays, worm farms, biodigester',
      ),
      ck('ev-t4-sanitation-waste-c4', 'Design waste sorting and recycling infrastructure'),
      ck('ev-t4-sanitation-waste-c5', 'Specify setback distances from water sources and dwellings'),
      ck(
        'ev-t4-sanitation-waste-c6',
  ...
  obj({
    ...
    checklist: [
      ck(
        'ev-t4-energy-system-c1',
        'Design primary generation system - solar array, wind, micro-hydro, or hybrid',
      ),
      ck('ev-t4-energy-system-c2', 'Design battery or thermal storage capacity'),
      ck(
        'ev-t4-energy-system-c3',
        'Design micro-grid distribution network to all dwellings and communal buildings',
      ),
      ck(
        'ev-t4-energy-system-c4',
        'Specify metering and monitoring infrastructure for energy governance',
      ),
      ck('ev-t4-energy-system-c5', 'Design backup and emergency power supply'),
      ck(
        'ev-t4-energy-system-c6',
        'Confirm energy system design is financially achievable within Tier 3 model',
      ),
    ],
    completionGate:
  ...
  obj({
    ...
    checklist: [
      ...
      ck('ev-t4-food-zones-c4', 'Design seed saving and nursery area'),
      ck(
        'ev-t4-food-zones-c5',
  ...
  obj({
    id: 'ev-t5-coordination-feedback',
    tierId: 't5-integration-design',
    ref: 'EV-T5.4',
    source: 'primary',
    sourceTypeId: PRIMARY,
  ...
  obj({
    ...
    checklist: [
      ck('ev-t6-financial-plan-c1', 'Define total Phase 1 capital requirement'),
      ck(
        'ev-t6-financial-plan-c2',
        'Define member contribution schedule - amounts, payment dates, default consequences',
      ),
      ck(
        'ev-t6-financial-plan-c3',
        'Define communal fund holding structure - bank account, trust, escrow',
      ),
      ck('ev-t6-financial-plan-c4', 'Define financial reporting schedule to all members'),
      ck(
        'ev-t6-financial-plan-c5',
  ...
  obj({
    ...
    checklist: [
      ck('ev-t6-onboarding-c1', 'Define application and selection process for new members'),
      ck(
        'ev-t6-onboarding-c2',
        'Define trial residency period - duration, expectations, review criteria',
      ),
      ck('ev-t6-onboarding-c3', 'Define full membership criteria and confirmation process'),
      ck(
        'ev-t6-onboarding-c4',
        'Design orientation program for new members - governance, systems, agreements',
      ),
      ck('ev-t6-onboarding-c5', 'Define mentorship or buddy system for new household integration'),
    ],
    completionGate:
  ...
  // EV-T6.9: the source labels this objective "6.6" (a duplicate of the
  // enterprise-sequencing ref above) - it was appended in v1.2 ("Adaptive
  // management protocol added to Tier 6"). 6.1-6.8 are occupied, so it takes the
  // next free slot. Content is verbatim; only the duplicate ref is disambiguated.
  obj({
    id: 'ev-t6-adaptive-management',
    tierId: 't6-phasing-resourcing',
    ref: 'EV-T6.9',
    source: 'primary',
    sourceTypeId: PRIMARY,
