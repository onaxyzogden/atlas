...
export const OFF_GRID_PRIMARY_OBJECTIVES: readonly PlanStratumObjective[] = [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s1-resilience-philosophy-c1', 'Define independence target per critical system - water, energy, food, communications, shelter'),
      ck('ofg-s1-resilience-philosophy-c2', 'Define acceptable backup or grid connection where full independence is not the target'),
      ck('ofg-s1-resilience-philosophy-c3', 'Define worst-case scenario resilience requirement - how long must all systems operate without resupply'),
      ck('ofg-s1-resilience-philosophy-c4', 'Confirm independence targets are achievable against site potential'),
      ck('ofg-s1-resilience-philosophy-c5', 'Document targets as design constraints - all Tier 3-4 systems sized against them'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s1-critical-systems-redundancy-c1', 'Classify all systems by criticality - life-safety, essential, convenience'),
      ck('ofg-s1-critical-systems-redundancy-c2', 'Define redundancy requirement for each life-safety system - dual source, backup storage, manual fallback'),
      ck('ofg-s1-critical-systems-redundancy-c3', 'Define minimum viable operation standard for each critical system during failure'),
      ck('ofg-s1-critical-systems-redundancy-c4', 'Define maximum acceptable downtime per system before life-safety threshold is breached'),
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s1-site-selection-access-c1', 'Confirm legal access - title access, road easement, right of way'),
      ck('ofg-s1-site-selection-access-c2', 'Assess physical access - road quality, seasonal passability, load-bearing capacity for materials delivery'),
      ck('ofg-s1-site-selection-access-c3', 'Identify access constraints that limit construction methodology or materials'),
      ck('ofg-s1-site-selection-access-c4', 'Define maintenance responsibility for access road'),
      ck('ofg-s1-site-selection-access-c5', 'Define emergency vehicle access requirements and confirm they are met'),
      ck('ofg-s1-site-selection-access-c6', 'Identify nearest sealed road and service centre distance'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s2-water-sources-yield-c1', 'Map all potential water sources - rainfall, springs, streams, groundwater'),
      ck('ofg-s2-water-sources-yield-c2', 'Assess reliability and yield of each source through dry season'),
      ck('ofg-s2-water-sources-yield-c3', 'Measure or estimate catchment area and yield for rainfall harvesting'),
      ck('ofg-s2-water-sources-yield-c4', 'Conduct bore or well yield test if groundwater is a primary source'),
      ck('ofg-s2-water-sources-yield-c5', 'Assess water source proximity to dwelling and infrastructure zones'),
      ck('ofg-s2-water-sources-yield-c6', 'Define minimum yield required per person per day and confirm source can meet it'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s2-energy-generation-potential-c1', 'Assess solar generation potential - peak sun hours by month, shading analysis'),
      ck('ofg-s2-energy-generation-potential-c2', 'Assess wind generation potential - speed, consistency, seasonal variation'),
      ck('ofg-s2-energy-generation-potential-c3', 'Assess micro-hydro potential if running water present - flow rate and head'),
      ck('ofg-s2-energy-generation-potential-c4', 'Assess biomass and wood fuel production capacity'),
      ck('ofg-s2-energy-generation-potential-c5', 'Estimate total energy demand per person per day for all critical systems'),
      ck('ofg-s2-energy-generation-potential-c6', 'Define generation gap - worst-case month demand vs. available generation'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s2-access-road-emergency-route-c1', 'Survey road surface condition along entire access route'),
      ck('ofg-s2-access-road-emergency-route-c2', 'Assess seasonal passability - wet season flooding, snow closure, fire access'),
      ck('ofg-s2-access-road-emergency-route-c3', 'Measure road width, turning radii, and load-bearing capacity'),
      ck('ofg-s2-access-road-emergency-route-c4', 'Identify bridge or culvert conditions on access route'),
      ck('ofg-s2-access-road-emergency-route-c5', 'Define emergency vehicle access requirements - ambulance, fire truck - and confirm route meets them'),
      ck('ofg-s2-access-road-emergency-route-c6', 'Identify alternative emergency access route if primary route fails'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s2-fire-risk-evacuation-c1', 'Assess fire risk by season - vegetation type, fuel load, proximity to fire-prone landscape'),
      ck('ofg-s2-fire-risk-evacuation-c2', 'Map evacuation routes from dwelling to safe assembly points and beyond'),
      ck('ofg-s2-fire-risk-evacuation-c3', 'Assess evacuation route passability during fire conditions - road surfaces, vegetation clearance'),
      ck('ofg-s2-fire-risk-evacuation-c4', 'Identify shelter-in-place potential if evacuation is not possible'),
      ck('ofg-s2-fire-risk-evacuation-c5', 'Record nearest fire station and response time estimate'),
      ck('ofg-s2-fire-risk-evacuation-c6', 'Define fire risk rating for the site under relevant regional framework'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s3-water-quality-treatment-c1', 'Test all primary water sources for biological contamination - bacteria, pathogens'),
      ck('ofg-s3-water-quality-treatment-c2', 'Test for chemical contamination - agricultural runoff, geological contaminants, heavy metals'),
      ck('ofg-s3-water-quality-treatment-c3', 'Test for naturally occurring contaminants - arsenic, fluoride, iron'),
      ck('ofg-s3-water-quality-treatment-c4', 'Record seasonal variation in water quality'),
      ck('ofg-s3-water-quality-treatment-c5', 'Define treatment requirements for potable use from each source'),
      ck('ofg-s3-water-quality-treatment-c6', 'Confirm treatment system is achievable and maintainable at this location'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s3-energy-demand-balance-c1', 'Calculate critical system energy demand - water pump, refrigeration, lighting, communications, heating'),
      ck('ofg-s3-energy-demand-balance-c2', 'Calculate total household energy demand'),
      ck('ofg-s3-energy-demand-balance-c3', 'Map demand against generation potential month by month'),
      ck('ofg-s3-energy-demand-balance-c4', 'Identify worst-case month - lowest generation, highest demand'),
      ck('ofg-s3-energy-demand-balance-c5', 'Define storage requirement to bridge daily and seasonal gaps'),
      ck('ofg-s3-energy-demand-balance-c6', 'Quantify the generation-demand gap that storage and backup must cover'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s3-communications-connectivity-c1', 'Test mobile phone coverage at dwelling site - carrier by carrier'),
      ck('ofg-s3-communications-connectivity-c2', 'Assess satellite phone and internet options and coverage'),
      ck('ofg-s3-communications-connectivity-c3', 'Identify nearest VHF or UHF radio repeater if applicable'),
      ck('ofg-s3-communications-connectivity-c4', 'Define emergency call options available - 000/911 equivalent, satellite SOS'),
      ck('ofg-s3-communications-connectivity-c5', 'Assess distance and travel time to nearest emergency services'),
      ck('ofg-s3-communications-connectivity-c6', 'Confirm emergency communication plan is viable with available technology'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s3-food-production-storage-conditions-c1', 'Assess growing season length and frost-free window'),
      ck('ofg-s3-food-production-storage-conditions-c2', 'Evaluate food production potential by zone - annual garden, perennial, animals'),
      ck('ofg-s3-food-production-storage-conditions-c3', 'Assess natural cold storage potential - cool rooms, root cellar conditions'),
      ck('ofg-s3-food-production-storage-conditions-c4', 'Assess food preservation requirements - drying, fermentation, canning capacity needed'),
      ck('ofg-s3-food-production-storage-conditions-c5', 'Define minimum food reserve requirement - weeks of supply as resilience target'),
      ck('ofg-s3-food-production-storage-conditions-c6', 'Confirm production potential can meet independence target defined in Tier 0'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s4-water-system-redundancy-c1', 'Define primary water source - rainfall, spring, bore, stream'),
      ck('ofg-s4-water-system-redundancy-c2', 'Define backup water source - separate source, not the same failure mode'),
      ck('ofg-s4-water-system-redundancy-c3', 'Define minimum storage capacity - days of reserve per person'),
      ck('ofg-s4-water-system-redundancy-c4', 'Define treatment system - type, maintenance requirements, failure response'),
      ck('ofg-s4-water-system-redundancy-c5', 'Define manual backup water delivery if powered system fails'),
      ck('ofg-s4-water-system-redundancy-c6', 'Confirm dual-source redundancy meets critical systems requirement from Tier 0'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s4-energy-system-redundancy-c1', 'Define primary generation system - solar, wind, hydro, hybrid'),
      ck('ofg-s4-energy-system-redundancy-c2', 'Define battery storage capacity - days of critical load at worst-case generation'),
      ck('ofg-s4-energy-system-redundancy-c3', 'Define backup generator - fuel type, capacity, fuel storage duration'),
      ck('ofg-s4-energy-system-redundancy-c4', 'Define load management protocol - critical loads protected, non-critical loads shed in shortage'),
      ck('ofg-s4-energy-system-redundancy-c5', 'Define manual alternatives for critical functions if all power fails'),
      ck('ofg-s4-energy-system-redundancy-c6', 'Confirm system meets worst-case month energy balance from Tier 2'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s4-food-security-storage-c1', 'Define minimum food reserve target - weeks of supply for all residents'),
      ck('ofg-s4-food-security-storage-c2', 'Define food production targets by enterprise - annual garden, perennial, animals'),
      ck('ofg-s4-food-security-storage-c3', 'Define food preservation and storage approach - cold storage, drying, fermentation, canning'),
      ck('ofg-s4-food-security-storage-c4', 'Define emergency resupply protocol - when reserve falls below minimum threshold'),
      ck('ofg-s4-food-security-storage-c5', 'Confirm production and storage strategy meets independence target from Tier 0'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s4-emergency-comms-response-c1', 'Define primary emergency communication method - satellite phone, PLB, radio'),
      ck('ofg-s4-emergency-comms-response-c2', 'Define backup emergency communication if primary fails'),
      ck('ofg-s4-emergency-comms-response-c3', 'Define emergency contact list - nearest neighbours, emergency services, medical'),
      ck('ofg-s4-emergency-comms-response-c4', 'Define medical emergency protocol - first aid capacity, evacuation trigger, transport method'),
      ck('ofg-s4-emergency-comms-response-c5', 'Define fire emergency protocol - shelter-in-place criteria, evacuation triggers, assembly points'),
      ck('ofg-s4-emergency-comms-response-c6', 'Confirm all residents are trained in emergency protocols before first habitation'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s4-shelter-thermal-performance-c1', 'Define thermal performance standard - minimum indoor temperature during coldest period'),
      ck('ofg-s4-shelter-thermal-performance-c2', 'Define primary heating system - fuel type, heat output, fuel storage capacity'),
      ck('ofg-s4-shelter-thermal-performance-c3', 'Define backup heating system - separate fuel type or passive fallback'),
      ck('ofg-s4-shelter-thermal-performance-c4', 'Define insulation standard required to meet thermal performance with defined heating capacity'),
      ck('ofg-s4-shelter-thermal-performance-c5', 'Define fuel reserve requirement - weeks of supply at peak demand'),
      ck('ofg-s4-shelter-thermal-performance-c6', 'Confirm shelter strategy meets life-safety threshold for coldest recorded conditions'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s5-water-system-infrastructure-c1', 'Design primary source infrastructure - bore pump, spring capture, rainwater tank array'),
      ck('ofg-s5-water-system-infrastructure-c2', 'Design backup source infrastructure - separate failure mode from primary'),
      ck('ofg-s5-water-system-infrastructure-c3', 'Design treatment train - sediment filter, biological treatment, disinfection'),
      ck('ofg-s5-water-system-infrastructure-c4', 'Design pressurised distribution to all dwelling and production points'),
      ck('ofg-s5-water-system-infrastructure-c5', 'Design manual backup fill point accessible without power'),
      ck('ofg-s5-water-system-infrastructure-c6', 'Specify all components to be locally repairable - no specialist-only parts'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s5-energy-system-infrastructure-c1', 'Design solar array - panel count, orientation, mounting, shading management'),
      ck('ofg-s5-energy-system-infrastructure-c2', 'Design battery bank - capacity, chemistry, BMS, temperature management'),
      ck('ofg-s5-energy-system-infrastructure-c3', 'Design inverter and charge controller - capacity and redundancy'),
      ck('ofg-s5-energy-system-infrastructure-c4', 'Design backup generator - sizing, fuel storage, exhaust, automatic or manual changeover'),
      ck('ofg-s5-energy-system-infrastructure-c5', 'Design critical load circuit - protected from non-critical loads during shortage'),
      ck('ofg-s5-energy-system-infrastructure-c6', 'Specify all components to be locally serviceable - no specialist-only systems'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s5-shelter-thermal-infrastructure-c1', 'Design insulation system - walls, floor, ceiling to defined thermal performance standard'),
      ck('ofg-s5-shelter-thermal-infrastructure-c2', 'Design primary heating system - wood stove, solar thermal, or hybrid'),
      ck('ofg-s5-shelter-thermal-infrastructure-c3', 'Design backup heating - separate fuel source or passive fallback'),
      ck('ofg-s5-shelter-thermal-infrastructure-c4', 'Design fuel storage - volume for defined reserve, safety separation from dwelling'),
      ck('ofg-s5-shelter-thermal-infrastructure-c5', 'Design passive solar gain where climate supports it'),
      ck('ofg-s5-shelter-thermal-infrastructure-c6', 'Specify construction standard for airtightness and thermal bridging reduction'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s5-food-production-infrastructure-c1', 'Design food production zones - garden beds, orchard, animal infrastructure'),
      ck('ofg-s5-food-production-infrastructure-c2', 'Design root cellar or cool room - temperature, humidity, ventilation'),
      ck('ofg-s5-food-production-infrastructure-c3', 'Design food preservation infrastructure - drying racks, canning station, fermentation area'),
      ck('ofg-s5-food-production-infrastructure-c4', 'Design seed saving and propagation infrastructure'),
      ck('ofg-s5-food-production-infrastructure-c5', 'Design food storage inventory system - minimum reserve tracking'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s5-communications-emergency-infrastructure-c1', 'Design satellite communications system - antenna placement, power supply, backup power'),
      ck('ofg-s5-communications-emergency-infrastructure-c2', 'Design emergency alert system - PLB placement and activation protocol'),
      ck('ofg-s5-communications-emergency-infrastructure-c3', 'Design VHF/UHF radio system if applicable - antenna, coverage test'),
      ck('ofg-s5-communications-emergency-infrastructure-c4', 'Design first aid station - equipment, storage, access'),
      ck('ofg-s5-communications-emergency-infrastructure-c5', 'Design fire safety infrastructure - extinguishers, fire blankets, roof access'),
      ck('ofg-s5-communications-emergency-infrastructure-c6', 'Design emergency assembly point and signage'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s6-systems-performance-monitoring-c1', 'Define critical system indicators - tank levels, battery state of charge, fuel stores, food reserve weeks'),
      ck('ofg-s6-systems-performance-monitoring-c2', 'Design monitoring method for each indicator - gauge, meter, manual check'),
      ck('ofg-s6-systems-performance-monitoring-c3', 'Define minimum threshold alerts - what level triggers a response before life-safety is compromised'),
      ck('ofg-s6-systems-performance-monitoring-c4', 'Define monitoring frequency - daily for life-safety systems'),
      ck('ofg-s6-systems-performance-monitoring-c5', 'Design log system - simple, auditable, maintainable at remote location'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s6-emergency-preparedness-monitoring-c1', 'Define seasonal access road assessment schedule - before wet season, before fire season'),
      ck('ofg-s6-emergency-preparedness-monitoring-c2', 'Define communications system test schedule - monthly at minimum'),
      ...
      ck('ofg-s6-emergency-preparedness-monitoring-c5', 'Design emergency preparedness drill schedule - residents practise protocols annually'),
    ],
    decisionGroups: [
  ...
  obj({
    ...
    checklist: [
      ck('ofg-s6-adaptive-management-c1', 'Define seasonal review process - after each worst-case season, review all system performance'),
      ck('ofg-s6-adaptive-management-c2', 'Define decision triggers - what system performance outcome requires a design or capacity change'),
      ck('ofg-s6-adaptive-management-c3', 'Define failure response protocol - what immediate actions follow a system failure'),
