...
export const FEATURE_SECTIONS: readonly FeatureSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'custom-phase-dependencies-milestones', label: 'Custom phase creation, stage dependencies, milestone view', phase: 'P2', status: 'partial' },
      { key: 'build-sequence-infrastructure-water-regen-revenue', label: 'Build sequence map, infrastructure/water/regeneration/revenue-first sequencing', phase: 'P2', status: 'partial' },
      ...
      { key: 'phase-completion-tracking-notes', label: 'Phase completion tracking and notes', phase: 'P2', status: 'partial' },
