...
export const FEATURE_SECTIONS: readonly FeatureSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'chicken-rabbit-pig-tractor-zones', label: 'Chicken tractor, rabbit tractor, pig disturbance zone planning', phase: 'P2', status: 'planned' },
      ...
      { key: 'fertility-manure-impact-heatmap', label: 'Fertility distribution heatmap, manure impact zone planning', phase: 'P3', status: 'planned' },
      { key: 'browse-pressure-overgrazing-risk', label: 'Browse pressure analysis, overgrazing risk detection', phase: 'P3', status: 'partial' },
      { key: 'livestock-land-fit-enterprise-zone', label: 'Livestock-to-land fit score, enterprise-by-zone allocation', phase: 'P3', status: 'planned' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'signs-in-creation-interpretive-mode', label: "'Signs in creation' interpretive mode", phase: 'MT', status: 'planned' },
  ...
  },
  {
    ...
    status: 'partial',
    features: [
      { key: 'water-flood-drought-scenario-sim', label: 'Water flow, flood, drought scenario simulation', phase: 'P3', status: 'planned' },
      { key: 'wind-shade-tree-canopy-sim', label: 'Wind exposure, shade growth, tree maturity, canopy expansion simulation', phase: 'P3', status: 'planned' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'ecological-wildlife-protection-rules', label: 'Ecological and wildlife protection rules', phase: 'P3', status: 'planned' },
      ...
      { key: 'why-this-suggestion-was-made', label: "'Why this suggestion was made' output (see Section 0d AI guardrails)", phase: 'P3', status: 'planned' },
  ...
  },
  {
    ...
    status: 'partial',
    features: [
      { key: 'feasibility-summary', label: 'Feasibility summary, constraint checklist, missing information checklist', phase: 'P2', status: 'partial' },
      { key: 'regulatory-risk-notes', label: 'Regulatory risk notes (see Section 0e for full regulatory layer)', phase: 'P2', status: 'planned' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'mission-weighted-donor-grant-income', label: 'Mission-weighted and donor/grant income modeling', phase: 'P3', status: 'planned' },
