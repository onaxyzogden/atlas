...
export const FEATURE_SECTIONS: readonly FeatureSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'infrastructure-cost-placeholder-per-structure', label: 'Infrastructure requirement summary, cost placeholder per structure', phase: 'P2', status: 'partial' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'temporary-vs-permanent-seasonal', label: 'Temporary vs permanent elements, seasonal phase view', phase: 'P2', status: 'planned' },
