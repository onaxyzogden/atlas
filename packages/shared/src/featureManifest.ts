...
export const FEATURE_SECTIONS: readonly FeatureSection[] = [
  {
    ...
    features: [
      ...
      { key: 'restore-previous', label: 'Restore previous project state', phase: 'P2', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'risk-opportunity-limitation-summaries', label: 'Risk summary, opportunity summary, limitation summary', phase: 'P1', status: 'done' },
      ...
      { key: 'what-this-land-wants', label: "'What this land wants' summary (AI)", phase: 'P2', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'solar-panel-placement-zones', label: 'Best solar panel placement zones', phase: 'P2', status: 'done' },
      { key: 'passive-solar-building-siting', label: 'Passive solar building siting analysis', phase: 'P2', status: 'done' },
      { key: 'prevailing-wind-shelter', label: 'Prevailing wind visualization, wind shelter analysis', phase: 'P1', status: 'done' },
      { key: 'windbreak-ventilation-corridors', label: 'Windbreak opportunity zones, cold wind exposure, ventilation corridor mapping', phase: 'P2', status: 'done' },
  ...
  },
  {
    ...
    status: 'partial',
    features: [
      { key: 'draw-custom-zones-naming-color', label: 'Draw custom zones, zone naming and color coding', phase: 'P1', status: 'done' },
      { key: 'zone-categories-primary-secondary', label: 'Zone categories, primary/secondary use designation', phase: 'P1', status: 'done' },
      ...
      { key: 'habitation-food-livestock-commons-planning', label: 'Habitation, food production, livestock, commons zone planning', phase: 'P1', status: 'done' },
      { key: 'prayer-spiritual-zone-planning', label: 'Prayer / spiritual zone planning', phase: 'MT', status: 'done' },
      { key: 'quiet-contemplation-zone-planning', label: 'Quiet contemplation zone planning', phase: 'MT', status: 'done' },
      { key: 'guest-retreat-education-event-parking', label: 'Guest / retreat, education, event, parking zone planning', phase: 'P2', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'arrival-sequence-design', label: 'Arrival sequence design (guest experience path)', phase: 'MT', status: 'done' },
      { key: 'parking-turning-delivery-checks', label: 'Parking capacity, turning radius, delivery access checks', phase: 'P3', status: 'done' },
      { key: 'quiet-circulation-routes', label: 'Quiet circulation routes', phase: 'MT', status: 'done' },
      { key: 'event-flow-night-lighting-safety', label: 'Event flow, night lighting route, safety and visibility checks', phase: 'P3', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'browse-pressure-overgrazing-risk', label: 'Browse pressure analysis, overgrazing risk detection', phase: 'P3', status: 'done' },
      ...
      { key: 'guest-safe-livestock-buffer', label: 'Guest-safe livestock buffer planning', phase: 'MT', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'agroforestry-windbreak-shelterbelt-silvopasture', label: 'Agroforestry band, windbreak, shelterbelt, silvopasture planning', phase: 'P2', status: 'done' },
      { key: 'pollinator-strip-companion-zone-notes', label: 'Pollinator strip, companion planting zone notes', phase: 'P2', status: 'done' },
      { key: 'tree-spacing-calculator', label: 'Tree spacing calculator', phase: 'P2', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'fire-emergency-infrastructure-failure-water-shortage', label: 'Fire / emergency, infrastructure failure, water shortage scenarios', phase: 'P3', status: 'done' },
      { key: 'layout-option-a-b-c-comparison', label: 'Alternate layout and design option A/B/C comparison', phase: 'P3', status: 'done' },
  ...
  },
  {
    ...
    status: 'stub',
    features: [
      { key: 'ai-site-summary', label: 'AI site summary (with data source attribution and confidence level)', phase: 'P3', status: 'done' },
      ...
      { key: 'ai-output-rating-feedback', label: 'AI output rating / feedback system', phase: 'P3', status: 'done' },
    ],
  },
  {
    id: 19,
    ...
    features: [
      ...
      { key: 'voiceover-script-slide-export', label: 'Voiceover-ready script export, slide presentation mode', phase: 'P4', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'good-fit-poor-fit-best-use', label: "'Good fit / poor fit', 'Best use of this land', 'Not recommended uses' summaries", phase: 'P2', status: 'done' },
      { key: 'what-must-be-solved-first', label: "'What must be solved first', 'What can wait' summaries", phase: 'P2', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'revenue-stream-tagging-enterprise-mapping', label: 'Revenue stream tagging, enterprise mapping', phase: 'P2', status: 'done' },
      ...
      { key: 'cost-sensitivity-hidden-costs-contingency', label: 'Cost sensitivity sliders, hidden cost flags, contingency recommendations', phase: 'P3', status: 'done' },
  ...
  },
  {
    ...
    status: 'partial',
    features: [
      { key: 'mobile-friendly-map-gps', label: 'Mobile-friendly map view, GPS location on site', phase: 'P2', status: 'done' },
      ...
      { key: 'offline-field-mode-sync', label: 'Offline field mode and sync (see Section 0g)', phase: 'P2', status: 'done' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'workspace-management', label: 'Workspace management', phase: 'P1', status: 'done' },
      { key: 'organization-settings', label: 'Organization settings', phase: 'P1', status: 'done' },
      ...
      { key: 'audit-log', label: 'Audit log', phase: 'P1', status: 'done' },
